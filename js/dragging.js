...
const dragRendering = {
    ...
    dragElements: [{ 
        id: undefined, // уникальный идентификатор предмета
        isDraggable : true, // перетаскиваемый элемент на холст
        isDragging : false, // элемент в настоящее время перетаскивается на холст 
        elem: undefined // перетаскиваемый элемент (см. stageElement.js, в частности Brick) 
    }],

    /**
     * пользовательская функция для определения конца перетаскивания
     * @param {*} elem перестал перетаскивать элемент
     */
